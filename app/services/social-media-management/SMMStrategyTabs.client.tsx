...
import { strategyTabsData } from './socialMediaData';
...
export default function SMMStrategyTabs() {
  ...
  return (
    <div className={styles.strategyGrid}>
      ...
      <div
        ...
        role="tablist"
        aria-label="Social Media Management Strategies"
      >
        {strategyTabsData.map((tab, idx) => {
          const IconComponent = iconMap[tab.iconKey] || FaPenNib;
