...
import { strategyTabsData } from './graphicDesignData';
...
export default function GdStrategyTabs() {
  ...
  return (
    <div className={styles.strategyGrid}>
      ...
      <div
        ...
        role="tablist"
        aria-label="Graphic Design Strategies"
      >
        {strategyTabsData.map((tab, idx) => {
          const IconComponent = iconMap[tab.iconKey] || FaLightbulb;
      ...
      {/* Crawlable Tab Content (All 6 panels in initial HTML, inactive use hidden) */}
