...
const subServices = [
  ...
  },
  {
    ...
    type: 'Per Project',
    features: [
      'Flyers, posters, brochures, pitch decks, ad creatives',
    ],
  },
];
      ...
      <section className="relative bg-brand-bgAlt pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 text-sm text-brand-textMid mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-brand-textDark font-medium">Graphic Design</span>
          </div>
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            <SectionLabel className="mx-auto">Add-On Service 06</SectionLabel>
